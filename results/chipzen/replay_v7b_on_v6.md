...
|---|---|---|---|---|
| preflop | 861 | 0.58 | 0.36 | 496 (58%) |
| flop | 291 | 0.60 | 0.51 | 67 (23%) |
| turn | 145 | 0.64 | 0.46 | 72 (50%) |
| river | 87 | 0.70 | 0.58 | 30 (34%) |

Most common changes of most-likely action (baseline → new):

- check/call → raise ½: 211
...
| 55 | preflop | 2d 9h | - | 11,725 | 12,525 | fold | 50bb: fold 1.00 | fold 0.11, check/call 0.89 |
...
| 49 | river | Ad 4h | 3c 9d Jc 5s 5c | 11,500 | 15,500 | fold | 50bb: fold 0.95, check/call 0.05 | fold 0.85, check/call 0.15 |
| 51 | preflop | 6s 2s | - | 11,500 | 12,300 | fold | 50bb: fold 1.00 | fold 0.99 |
| 63 | preflop | Kd Jh | - | 10,750 | 11,950 | fold | 50bb: fold 0.91, check/call 0.09 | check/call 1.00 |
...
Facing a bet of the pot or more on those lines (50): the companion calls with mean probability 0.23 and folds with 0.77.
...
**-9,600 vs Blueprint**, hand 80 (250b315e), we held Qd 7h, they showed Ah 8h.
  ...
  - turn    board As 5h 8s 7d    key `11/1221/1` to call 0 → played **check/call**; new set: check/call 0.99, raise ½ 0.01
  - river   board As 5h 8s 7d Qs key `11/1221/11/1` to call 0 → played **raise 2×**; new set: raise ½ 0.18, raise pot 0.16, raise 2× 0.64, all-in 0.01
