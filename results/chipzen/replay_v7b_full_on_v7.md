...
logged misses 167, baseline lookup misses 167 (these should match), new-set misses 46 after its cap-2 companions answered 121 of the primary's 167; 1604 decisions compared.
...
| 69 | preflop | 5d 6c | - | 11,100 | 12,300 | fold | 25bb: fold 1.00 | no entry |
| 95 | preflop | Ac Js | - | 11,050 | 15,050 | check/call | 18bb: check/call 1.00 | no entry |
| 43 | preflop | 6c 8d | - | 10,700 | 11,900 | fold | 50bb: fold 1.00 | no entry |
| 77 | preflop | 9h 8c | - | 10,700 | 12,500 | fold | 25bb: fold 0.82, check/call 0.18 | no entry |
| 71 | river | 5h 5d | Tc 7h 2s Td Qs | 10,200 | 15,000 | fold | 25bb: fold 0.90, check/call 0.10 | no entry |
| 13 | preflop | 7d Qh | - | 9,850 | 10,450 | fold | 100bb: fold 1.00 | no entry |
| 64 | flop | 9c 4c | Td 7s 8s | 9,750 | 12,150 | fold | 35bb: fold 1.00 | no entry |
| 1 | preflop | Jh 9s | - | 9,700 | 10,300 | fold | 100bb: fold 1.00 | no entry |
| 9 | preflop | 3h 4h | - | 9,700 | 10,700 | fold | 100bb: fold 1.00 | no entry |

Facing a bet of the pot or more on those lines (80): the companion calls with mean probability 0.17 and folds with 0.83.
...
**-6,500 vs Blueprint**, hand 42 (cfd7fb0e), we held Ah Qh, they showed As Ts.
  ...
  - preflop board -              key `45` to call 1,150 → played **check/call**; new set: fold 0.01, check/call 0.99
...
**-6,000 vs Blueprint**, hand 89 (d5f9d67c), we held Ks 3h, they showed As 6c.
  ...
  - river   board 9c Ts 4c 7d 5h key `21/121/11/45` to call 3,075 → played **fold**; new set: fold 1.00
...
**-5,525 vs Blueprint**, hand 98 (d5f9d67c), we held 8d Kh, they showed Qc Kd.
  ...
  - preflop board -              key `25` to call 13,675 → played **check/call**; new set: fold 0.50, check/call 0.50
...
**-5,000 vs Blueprint**, hand 72 (bb5594e5), we held Ah 8s, they showed 9s Ac.
  ...
  - preflop board -              key `25` to call 1,050 → played **check/call**; new set: check/call 1.00
