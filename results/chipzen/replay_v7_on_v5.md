...
| flop | 629 | 0.63 | 0.58 | 143 (23%) |
| turn | 471 | 0.64 | 0.58 | 120 (25%) |
| river | 333 | 0.65 | 0.58 | 72 (22%) |

Most common changes of most-likely action (baseline → new):

- check/call → raise ½: 235
- raise ½ → check/call: 68
...
|---|---|---|---|---|---|---|---|---|
| 18 | river | Ac 3h | Jh Qh Qs 7h 9c | 10,258 | 15,098 | fold | 70bb: fold 0.99 | fold 0.97 |
| 15 | river | 3c As | Qs 7d 3s 5d 5h | 5,781 | 16,581 | fold | 100bb: check/call 1.00 | fold 1.00 |
| 31 | turn | Ts Ac | 2s Th 8s 4s | 5,031 | 10,791 | check/call | 50bb: check/call 1.00 | check/call 1.00 |
| 35 | river | As 3d | 7s 5d Ad Jh Th | 4,739 | 15,323 | fold | 70bb: fold 0.97 | fold 0.84, check/call 0.16 |
| 1 | river | Qs 2s | 9h 2c Tc Kd 9c | 3,944 | 10,012 | fold | 100bb: fold 0.97 | fold 0.99 |
| 8 | turn | Qs 7s | 2c 9s Qd Ts | 3,600 | 6,600 | check/call | 50bb: check/call 1.00 | check/call 1.00 |
| 3 | turn | As 5s | 3s 2s 9h Ah | 3,320 | 6,640 | raise 2× | 100bb: check/call 0.46, raise pot 0.14, raise 2× 0.38 | check/call 0.50, raise pot 0.27, raise 2× 0.13 |
| 12 | river | 2c 3s | Ks 2d 3c 6c 5d | 3,300 | 8,300 | check/call | 100bb: check/call 0.87, all-in 0.06 | fold 0.20, check/call 0.58, raise pot 0.21 |
...
| 24 | river | Ts Kh | 3s 5s 5c 7s 8s | 2,457 | 4,977 | fold | 50bb: fold 0.99 | no entry |
| 8 | turn | Jh Jd | 8c 3d 5d 9c | 2,400 | 6,400 | all-in | 100bb: check/call 0.17, raise ½ 0.77 | check/call 0.12, raise ½ 0.60, raise pot 0.12, all-in 0.13 |
| 33 | river | Ks Ad | 6c 9d 4c Jd Qc | 2,376 | 6,336 | fold | 50bb: fold 1.00 | no entry |
| 48 | river | 5c Qh | 3c Qs Ks 7h 2d | 2,280 | 6,080 | check/call | 50bb: fold 0.22, check/call 0.78 | fold 0.07, check/call 0.92 |
| 40 | river | Kc Tc | Kd Jh 8s Jd Td | 2,249 | 13,049 | fold | 50bb: fold 0.35, check/call 0.65 | fold 0.43, check/call 0.57 |
...
| 3 | turn | 8s As | 2h Jc 9c 7d | 1,756 | 4,008 | fold | 100bb: fold 1.00 | fold 0.93 |
...
| 35 | turn | As 3d | 7s 5d Ad Jh | 1,386 | 3,906 | raise ½ | 70bb: check/call 0.55, raise ½ 0.44 | check/call 0.57, raise ½ 0.39 |

Facing a bet of the pot or more on those lines (7): the companion calls with mean probability 0.52 and folds with 0.40.
