...
logged misses 141, baseline lookup misses 143 (these should match), new-set misses 117 after its cap-2 companions answered 160 of the primary's 277; 2422 decisions compared.
...
|---|---|---|---|---|---|---|---|
| 24 | river | 9h 9c | 6c 4c 7s 6s 4d | 12,184 | 15,580 | 0.21 | 0.41 |
...
Mean call probability over all 13: baseline 0.78, new 0.88.
...
|---|---|---|---|---|---|---|---|---|
| 53 | preflop | Kd 3d | - | 18,120 | 19,320 | check/call | 12bb: check/call 1.00 | no entry |
...
| 28 | turn | 5d 6c | Th 5c 2d Tc | 3,600 | 6,600 | fold | 25bb: fold 0.46, check/call 0.54 | no entry |
| 44 | turn | 4d 4c | Ks 8s Jd 5s | 3,480 | 8,120 | fold | 25bb: fold 0.85, check/call 0.15 | no entry |
...
| 22 | turn | Qs Qd | 3s Jh Qc 3d | 3,133 | 7,741 | check/call | 25bb: check/call 1.00 | no entry |
| 45 | preflop | 8d 6c | - | 2,693 | 4,693 | fold | 18bb: fold 0.49, check/call 0.51 | no entry |
...
| 24 | river | Ts Kh | 3s 5s 5c 7s 8s | 2,457 | 4,977 | fold | 35bb: fold 1.00 | no entry |
...
| 34 | river | 2h 5s | 5d 3h 9c 8s 5h | 2,040 | 5,040 | check/call | 12bb: check/call 1.00 | no entry |
...
| 56 | river | Jd Ac | 7c 6d Ts 5s 9h | 1,800 | 5,800 | fold | 35bb: fold 1.00 | no entry |
| 3 | turn | 8s As | 2h Jc 9c 7d | 1,756 | 4,008 | fold | 100bb: fold 0.90, check/call 0.10 | fold 0.93 |

Facing a bet of the pot or more on those lines (13): the companion calls with mean probability 0.64 and folds with 0.36.

## River shoves: the primary's answer against the companion's

12 river decisions faced an all-in with a primary node; the companion could answer 12. Net is the hand's result as played; a hand the companion would fold instead of calling loses only what was in before the shove.

| hand | ours | board | to call | pot | played | net | primary call | companion call |
|---|---|---|---|---|---|---|---|---|
| 50 | Kd Ah | 9c 8d 5d 2s Jc | 14,096 | 18,420 | fold | -2,162 | 0.00 | 0.00 |
| 24 | 9h 9c | 6c 4c 7s 6s 4d | 12,184 | 15,580 | check/call | +6,118 | 0.21 | 0.41 |
| 18 | Ac 3h | Jh Qh Qs 7h 9c | 10,258 | 15,098 | fold | -2,420 | 0.00 | 0.00 |
| 15 | 3c As | Qs 7d 3s 5d 5h | 5,781 | 16,581 | fold | -5,400 | 0.45 | 0.45 |
| 75 | Qc 8c | 4c Ah 4d Ad Qs | 5,254 | 14,022 | check/call | -9,638 | 0.62 | 0.52 |
| 35 | As 3d | 7s 5d Ad Jh Th | 4,739 | 15,323 | fold | -5,292 | 0.02 | 0.02 |
| 30 | Ks 5s | 3s 6d Qs Tc Ac | 2,633 | 10,733 | fold | -4,050 | 0.00 | 0.00 |
| 24 | Ts Kh | 3s 5s 5c 7s 8s | 2,457 | 4,977 | fold | -1,260 | 0.00 | 0.00 |
| 40 | Kc Tc | Kd Jh 8s Jd Td | 2,249 | 13,049 | fold | -5,400 | 0.56 | 0.56 |
| 34 | 2h 5s | 5d 3h 9c 8s 5h | 2,040 | 5,040 | check/call | +1,941 | 1.00 | 1.00 |
| 56 | Jd Ac | 7c 6d Ts 5s 9h | 1,800 | 5,800 | fold | -2,000 | 0.00 | 0.00 |
| 28 | 8s Th | 4c Kh 8d 5h 6d | 642 | 1,962 | fold | -660 | 0.54 | 0.54 |

Calls that lost: -9,638 chips in total; of that, the companion would have folded calls worth +0 (the losing calls' own size where its call probability is under 0.5).
...
**-9,638 vs mr_hide**, hand 75 (97131196), we held Qc 8c, they showed 2h As.
  ...
  - river   board 4c Ah 4d Ad Qs key `31/21/21/5` to call 5,254 → played **check/call**; new set: fold 0.48, check/call 0.52
...
**-8,346 vs r0ckGarden**, hand 55 (524b6f3a), we held Qc 3c, they showed 8d 8s.
  ...
  - preflop board -              key `45` to call 1,500 → played **check/call**; new set: fold 0.63, check/call 0.37
