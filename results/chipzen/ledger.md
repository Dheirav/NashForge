# Arena ledger: win rate by version

Versions in the order they first played. Chips per hand carries a standard error; the match win rate does not, because a match is about nineteen hands.
...
|---|---|---|---|---|---|
| r0ckGarden | 19 | 16 | 1161 | +130,000 | +112 |
| hoops | 13 | 7 | 367 | +3,780 | +10 |
| mr_hide | 12 | 4 | 293 | -40,000 | -137 |
| PluriBot | 2 | 2 | 15 | +20,000 | +1333 |
| pebble | 1 | 1 | 28 | +10,000 | +357 |
...
| opponent | matches | won | hands | net | chips/hand |
|---|---|---|---|---|---|
| hoops | 24 | 13 | 735 | +12,599 | +17 |
| mr_hide | 16 | 7 | 569 | -20,000 | -35 |
| r0ckGarden | 13 | 12 | 766 | +110,000 | +144 |
...
| opponent | matches | won | hands | net | chips/hand |
|---|---|---|---|---|---|
| Blueprint | 20 | 13 | 1269 | +60,000 | +47 |
| hoops | 1 | 0 | 14 | -10,000 | -714 |
...
| opponent | matches | won | hands | net | chips/hand |
|---|---|---|---|---|---|
| Blueprint | 20 | 15 | 1613 | +100,000 | +62 |
| r0ckGarden | 2 | 1 | 40 | +0 | +0 |
| mr_hide | 2 | 2 | 21 | +20,000 | +952 |
| hoops | 1 | 1 | 19 | +10,000 | +526 |
...
| opponent | matches | won | hands | net | chips/hand |
|---|---|---|---|---|---|
| runner1 | 1 | 1 | 78 | +10,000 | +128 |
| mellyy | 1 | 1 | 94 | +10,000 | +106 |
...
| opponent | matches | won | hands | net | chips/hand |
|---|---|---|---|---|---|
| mr_hide | 14 | 8 | 411 | +20,000 | +49 |
| hoops | 8 | 5 | 222 | +20,000 | +90 |
| r0ckGarden | 8 | 5 | 302 | +20,000 | +66 |
...
| opponent | matches | won | hands | net | chips/hand |
|---|---|---|---|---|---|
| Blueprint | 15 | 9 | 1029 | +30,000 | +29 |
| mr_hide | 3 | 3 | 136 | +30,000 | +221 |
| hoops | 2 | 0 | 134 | -20,000 | -149 |
| PoetAndCoder | 1 | 1 | 8 | +10,000 | +1250 |
